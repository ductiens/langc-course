...
# Hàm này demo cách tạo Chroma vector store và search cơ bản.
def chroma_basics():
...
# Hàm này demo cách tạo Chroma vector store và search cơ bản, nhưng có thêm score.
...
# Hàm này demo tìm kiếm có lọc metadata.
...
# Hàm này demo biến vector store thành retriever.
def as_retriever():
...
# Hàm này demo cách lưu Chroma xuống disk để dùng lại sau.
def persist_chroma():
